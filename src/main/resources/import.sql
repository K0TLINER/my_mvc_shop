...
-- Members
insert into members(modified_date, registration_date, birth_date, email, nickname, password, phone, role, social_flag, active, member_id) values(null, NOW() - 1, '1999-08-24', 'admin@naver.com', 'admin', 'admin', '010-5555-0302', 1, false, true, 0x0FCCD174645B4C3089F4E554712D6D7D);
